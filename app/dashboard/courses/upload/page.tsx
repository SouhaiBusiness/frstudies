...
const modulesByFiliereAndSemester = {
  literature: {
    "1": [
      { value: "Initiation aux genres dramatiques", label: "Initiation aux genres dramatiques" },
      ...
      { value: "Typologie des textes narratifs", label: "Typologie des textes narratifs" },
    ],
    "2": [
      ...
      { value: "Introduction à l'interculturel", label: "Introduction à l'interculturel" },
    ],
    "3": [
    ...
    "4": [
      { value: "initiation à la linguistique", label: "initiation à la linguistique" },
      { value: "Morphosyntaxe", label: "Morphosyntaxe" },
      { value: "initiation à la recherche", label: "initiation à la recherche" },
      { value: "Histoire des idées", label: "Histoire des idées" },
      { value: "Poésie", label: "Poésie" },
      { value: "Théâtre classique", label: "Théâtre classique" },
    ],
    "5": [
      { value: "Théories du texte littéraire 1", label: "Théories du texte littéraire 1" },
    ...
    "6": [
      ...
      { value: "Théories du texte littéraire", label: "Théories du texte littéraire" },
      { value: "Etude des médias", label: "Etude des médias" },
      { value: "Les écritures de soi", label: "Les écritures de soi" },
      { value: "Analyse des textes littéraires 2", label: "Analyse des textes littéraires 2" },
